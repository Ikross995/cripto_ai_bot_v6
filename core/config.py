...
class Config(BaseModel):
    ...
    tp_levels: str = Field(default="1.2,1.8,2.3")  # SMART TP: 1.5%, 3%, 5% - balanced for leverage trading
    ...
    def from_env(cls, env_file: Optional[str] = None) -> "Config":
        ...
        env_mapping = {
            ...
            'bt_conf_min': float(os.getenv('BT_CONF_MIN', '0.45')),  # Изменено для 15m
            ...
            'tp_levels': os.getenv('TP_LEVELS', '1.1,2.1,3.5'),  # Smart TP levels for leverage trading
