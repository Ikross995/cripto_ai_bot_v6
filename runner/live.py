...
class LiveTradingEngine:
    def __init__(self, config: Config):
        ...
        if DCAManager and getattr(config, "use_dca", False):
            try:
                ...
                self.logger.info("DCA integration enabled - will initialize with Binance client")
            except Exception as e:
                self.logger.warning("DCAManager init failed: %s", e)
            ...
            if hasattr(self, 'client') and self.client:
                try:
                    ...
                    order_result = self.client.place_order(
                        ...
                        quantity=api_quantity  # Use precision-corrected quantity
                    )
